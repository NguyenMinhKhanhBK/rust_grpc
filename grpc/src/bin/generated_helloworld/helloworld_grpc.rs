...
pub trait Greeter {
    fn say_hello(&self, o: ::grpc::ServerHandlerContext, req: ::grpc::ServerRequestSingle<super::helloworld::HelloRequest>, resp: ::grpc::ServerResponseUnarySink<super::helloworld::HelloResponse>) -> ::grpc::Result<()>;
}
...
impl GreeterClient {
    pub fn say_hello(&self, o: ::grpc::RequestOptions, req: super::helloworld::HelloRequest) -> ::grpc::SingleResponse<super::helloworld::HelloResponse> {
